...
//        int[] nf = new int[intarrayh.length + intarrayp.length];
//
//            for (int y=0;y<intarrayh.length;y++){
//                nf[y]=intarrayh[y];
//                for(int x=0;x<intarrayp.length;x++){
//                nf[x+intarrayh.length]=intarrayp[x];
//                }
//            }
//        Log.d(TAG,"Array nf:"+ Arrays.toString(nf));
//        int[] f = new int[nf.length + intarrayb.length];
//
//        for (int y=0;y<nf.length;y++){
//            f[y]=nf[y];
//            for(int x=0;x<intarrayb.length;x++){
//                f[x+nf.length]=intarrayb[x];
//            }
//        }
//        int [] combined = ArrayUtils.addAll(nf, f);
//        for(int a=0;a<f.length;a++){
//            Log.d(TAG,"array f :"+f[a]);}
//        Arrays.sort1(f);
...
//        }
//for(int a=0;a<f.length;a++) {
//    if (Arrays.asList(f).contains(80)) {
//        Log.d(TAG, "Contains 80");
//    } else if (Arrays.asList(f).contains(75)) {
//        Log.d(TAG, "Contains 75");
//    } else if (Arrays.asList(f).contains(0)) {
//        Log.d(TAG, "Contains 0");
//    }
//}

//        System.arraycopy(intarrayh, 0, nf, 0, intarrayp.length);
//        System.arraycopy(intarrayp, 0, nf, intarrayh.length, intarrayp.length);
//
//        int[] f = new int[nf.length + intarrayb.length];
//        System.arraycopy(nf, 0, f, 0, intarrayb.length);
//        System.arraycopy(intarrayb, 0, f, nf.length, intarrayb.length);

//        Log.d(TAG, " new string"+f.length);
        Log.d(TAG, " intarrayh(heading)"+intarrayh.length);
        Log.d(TAG, " intarrayp(points)"+intarrayp.length);
        Log.d(TAG, " intarrayb (para)"+intarrayb.length);

//        Log.d(TAG, " array f:"+ Arrays.toString(f));
