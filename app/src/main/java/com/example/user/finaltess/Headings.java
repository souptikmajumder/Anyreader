...
//        int[] ff={0,75,316,538,713};
        ...
        for(int i=0;i<intarrayh.length;i++){
            int k=i+1;
            baseApi.setImage(BitmapFactory.decodeFile("/sdcard/Any Reader/Headings/h" + intarrayh[i] + ".jpg"));
            storetext.add(" "+" "+" "+" Say "+k+ " for "+" "+" "+" " + baseApi.getUTF8Text()+" "+" "+" "+" or ");
